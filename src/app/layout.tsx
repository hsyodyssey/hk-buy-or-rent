...
const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || "https://hkrs.vercel.app";

export const metadata: Metadata = {
  metadataBase: new URL(SITE_URL),
  title: {
    default: "香港房产成本分析器 | 买房 vs 租房 真实成本对比",
    template: "%s | 香港房产成本分析器",
  },
  description:
  ...
  authors: [{ name: "HK Property Analyzer" }],
  creator: "HK Property Analyzer",
  openGraph: {
    type: "website",
    locale: "zh_CN",
    ...
    url: SITE_URL,
    siteName: "香港房产成本分析器",
    title: "香港房产成本分析器 | 买房 vs 租房 真实成本对比",
    description:
      "交互式分析香港买房与租房的真实成本。支持自住对比和以租养房模式，包含盈亏平衡分析和多年趋势预测。",
  },
  twitter: {
    card: "summary_large_image",
    title: "香港房产成本分析器 | 买房 vs 租房",
    description:
...
const jsonLd = {
  ...
  "@type": "WebApplication",
  name: "香港房产成本分析器",
  alternateName: "HK Property Cost Analyzer",
  description:
